...
function UpdateCard(props) {
  ...
  const verLine = info && info.repo && !info.error ? 'v' + (info.version || '?') + ' · ' + (info.current || '') : ''
  ...
  return React.createElement('div', { style: { background: 'var(--dsw-alias-bg-layer-1,#161a23)', border: '1px solid var(--bi-card-border,#3d2f1f)', borderRadius: '12px', padding: '14px 16px', margin: '8px 0' } },
    React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' } },
      ...
      React.createElement('button', { className: 'bi-btn', style: iconBtn, onMouseEnter: iconBtnHover.onMouseEnter, onMouseLeave: iconBtnHover.onMouseLeave, title: '检查更新', disabled: busy === 'check', onClick: function () { doCheck(false) } }, React.createElement(MiniIcon, { d: ICON_BOLT, viewBox: '0 0 1179 1024' })),
      React.createElement('button', { className: 'bi-btn', style: Object.assign({}, iconBtn, { opacity: canRun ? 1 : 0.4 }), onMouseEnter: iconBtnHover.onMouseEnter, onMouseLeave: iconBtnHover.onMouseLeave, title: '一键更新', disabled: !canRun, onClick: doRun }, React.createElement(MiniIcon, { d: ICON_CHECK }))),
